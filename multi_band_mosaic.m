function multi_band_mosaic(im_n,X,imfolder,imsize,edge_n,edge_list,im_ch,im,lambda,K_smooth,intv_mesh,R,M,D,ur,vr,mosaich,mosaicw,m_v0_,m_v1_,m_u0_,m_u1_,fe,imh_,imw_,ubox,vbox,R_pair)
refi=0;
...
for j=1:176
    for ii = 1:im_n
    imfile{ii} = sprintf('..\.jpg', imfolder,ii);
end
b=zeros(1057,960,2);
im = cell(im_n,1);
for ii = 1:im_n
